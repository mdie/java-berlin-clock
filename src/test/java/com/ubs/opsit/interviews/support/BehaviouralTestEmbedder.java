...
public final class BehaviouralTestEmbedder extends ConfigurableEmbedder {
    ...
    public BehaviouralTestEmbedder usingStepsFrom(Object... stepsSource) {
        ...
        stepsFactory = new InjectableInstanceStepsFactory(configuration(), stepsSource);
        /* author: mdie
         * by replacing old code with overridden implementation of InstanceStepsFactory class you can inject your own object into property (using reflection) 
